...
const Hero: NextPage = () => {
  return (
    <>
      <PageLayout className="flex flex-wrap">
        <div className="flex w-full items-center lg:w-1/2">
          <div className="mb-8 max-w-2xl">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 dark:text-white lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight">
              Get Captions and Hashtags for Your Social Media Posts
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 dark:text-gray-300 lg:text-xl xl:text-2xl">
              InstaCapt is a free online platform that generates catchy captions
              and trending hashtags for your social media posts. Whether you are
              an influencer, a business, or an individual, we have got you
              covered with engaging content ideas to boost your online presence.
            </p>
